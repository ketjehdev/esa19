...
<head>
    ...
    <title>Admin Dashboard | ESA 19</title>
    <!-- Custom CSS -->
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <h1 class="page-title text-truncate text-dark font-weight-medium mb-1">Dashboard</h1>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-row justify-content-between mb-3">
                                    ...
                                    <a href="{{ route('admin/form') }}"><button class="btn btn-cyan" style="width: 100%">Form Managament</button></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
