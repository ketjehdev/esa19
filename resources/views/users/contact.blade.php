                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <h1 class="page-title text-truncate text-dark font-weight-medium mb-1">Contact Person</h1>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card text-center">
                            <div class="px-2 py-2">
                                <h3 class="text-dark">
                                    <strong>Ghibran</strong>
                                </h3>
                            </div>
                            <p class="text-center">
                                <span class="text-muted">+62 822-9488-2672</span>
                            </p>
                            <div class="card-body">
                                <a href="{{ URL::to('https://wa.me/6282294882672?text=Halo%20mimin%20ESA%2019') }}"><button class="btn btn-success" style="width: 100%">WhatsApp</button></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card text-center">
                            <div class="px-2 py-2">
                                <h3 class="text-dark">
                                    <strong>Fathur</strong>
                                </h3>
                            </div>
                            <p class="text-center">
                                <span class="text-muted">+62 822-1731-0126</span>
                            </p>
                            <div class="card-body">
                                <a href="{{ URL::to('https://wa.me/6282217310126?text=Halo%20mimin%20ESA%2019') }}"><button class="btn btn-success" style="width: 100%">WhatsApp</button></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card text-center">
                            ...
                            <p class="text-center">
                                <span class="text-muted">+62 882-6101-1730</span>
                            </p>
                            <div class="card-body">
                                <a href="{{ URL::to('https://wa.me/6288261011730?text=Halo%20mimin%20ESA%2019') }}"><button class="btn btn-success" style="width: 100%">WhatsApp</button></a>
                            </div>
                        </div>
                    </div>
                </div>
