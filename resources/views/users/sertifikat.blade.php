    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{{ route('users/form') }}"
                                aria-expanded="false"><i data-feather="file-text" class="text-warning feather-icon"></i><span
        ...
        <div class="page-wrapper">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <h1 class="page-title text-truncate text-dark font-weight-medium mb-1">Sertifikat</h1>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <!-- *************************************************************** -->
                ...
                <div class="row">
                    <div class="col-12">
                        <form action="{{ url('/users/sertifikat') }}" method="GET" class="my-3">
                            <input type="search" name="search" style="display: inline;border:1px solid #aaa;padding:8px;" placeholder="Cari sesuai nama anda">
