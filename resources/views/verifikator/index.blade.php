...
<head>
    ...
    <title>Validasi Data | ESA 19</title>
    <!-- Custom CSS -->
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item" style="border-radius: 100px"> <a class="sidebar-link sidebar-link" href="{{ route('verifikator/index') }}"
                                aria-expanded="false"><i data-feather="user-check" class="feather-icon"></i><span
                                    class="hide-menu">Validasi</span></a></li>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <h1 class="page-title text-truncate text-dark font-weight-medium mb-1">Laporan Pendaftaran</h1>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                                ...
                                                @if ($item->lomba == "Spelling Bee")
                                                    @if ($item->status == "not verified")
                                                        <tr>
                                                            ...
                                                            <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                                <form action="{{ url('/verifikator/eduxart/'.$item->id) }}" method="POST">
                                                                    @csrf
                                                            ...
                                                            <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                                <a onclick="return myFunction();" href="{{ url('/verifikator/destroyEduxart/'.$item->id) }}">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($item->lomba == "Mobile Legends")
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                            <form action="{{ url('/verifikator/sport/'.$item->id) }}" method="POST">
                                                                @csrf
                                                                <select class="py-2 px-2 text-center" style="font-size:  13px;" name="status">
                                                                    @if ($item->status == "verified")
                                                                        <option value="verified">verified</option>    
                                                        ...
                                                        <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                            <a onclick="return myFunction();" href="{{ url('/verifikator/destroySport/'.$item->id) }}">
                                                                <button class="btn btn-danger">
                                                                    <i data-feather="trash-2" class="feather-icon"></i>
                                                                </button>
                                                                </a>
                                        ...
                                        <tbody>
                                            ...
                                            @if ($item->lomba == "LCTP Pramuka")
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                            <form action="{{ url('/verifikator/amity/'.$item->id) }}" method="POST">
                                                                @csrf
                                                                <select class="py-2 px-2 text-center" style="font-size:  13px;" name="status">
                                                                    @if ($item->status == "verified")
                                                                        <option value="verified">verified</option>    
                                                        ...
                                                        <td class="border-top-1 text-center text-muted px-2 py-4 font-14">
                                                            <a onclick="return myFunction();" href="{{ url('/verifikator/destroyAmity/'.$item->id) }}">
                                                                <button class="btn btn-danger">
                                                                    <i data-feather="trash-2" class="feather-icon"></i>
                                                                </button>
                                                                </a>
